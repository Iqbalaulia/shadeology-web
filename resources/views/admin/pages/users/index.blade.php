                    ...
                    <form id='editForm' class="needs-validation" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group mb-3">
                                        <label for="edit_phone">Number Phone</label>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-3">
                                        <label for="edit_domisili">City</label>
                                        <input class="form-control" id="edit_domisili" name="domisili" type="text"
                                            required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control digits" id="edit_affiliation" name="affiliate">
                                            <option>Tiktok</option>
                                            <option>Shoppe</option>
                                            <option>All</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-3">
                                        <label for="edit_shade_foundation">Shade Foundation</label>
                                        <input class="form-control" id="edit_shade_foundation" name="shade_foundation"
                                            type="text" required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group mb-3">
                                        <label for="edit_merried_status">Merried</label>
                                        <select class="form-control digits" id="edit_merried_status"
                                            name="merried_status">
                                            <option>Single</option>
                                            <option>Sudah Menikah</option>
                                            <option>Sudah Menikah & Punya Anak</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group mb-3">
                                        <label for="edit_barter">Barter</label>
                                        <select class="form-control digits" id="edit_barter" name="barter">
                                            <option>Ya</option>
                                            <option>Tidak</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group ">
                                        <h4 for="social_media" class="font-weight-bold mb-1">Social Media</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" id="edit_instagram" name="instagram" type="text"
                                            required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group mb-3">
                                        <label for="edit_followers_instagram">Followers</label>
                                        <input class="form-control" id="edit_followers_instagram"
                                            name="followers_instagram" type="number" required>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" id="edit_tiktok" name="tiktok" type="text"
                                            required>
                                ...
                                <div class="col">
                                    <div class="form-group mb-3">
                                        <label for="edit_followers_tiktok">Followers</label>
                                        <input class="form-control" id="edit_followers_tiktok" name="followers_tiktok"
                            ...
                            <div class="row">
                                <div class="col">
                                    <label for="edit_rate_card">Rate Card</label>
                                    <div id="editRateCardPreview" class="mb-2"></div>
                                    <input class="form-control" id="edit_rate_card" name="rate_card" type="file"
                                        accept=".pdf,image/*">
                                </div>
                            </div>
                        </div>
