              ...
              <div class="row">
                          ...
                          <div class="subscribe-form">
                              <form method="post" action="#">
                                  <div class="form-group">
                                      ...
                                      <button type="button" class="theme-btn"><span class="btn-title"><i
                                                  class="fa-sharp fa-thin fa-paper-plane"></i></span></button>
                                  </div>
                              </form>
                          </div>
                  ...
                  <div class="footer-column col-xl-3  col-lg-6 col-md-6 col-sm-6">
                      <div class="footer-widget contacts-widget">
                          ...
                          <div class="text">2972 Westheimer Rd. Santa Ana, Illinois <br> 85486</div>
                          <ul class="contact-info">
                              <li><a class="text-style-two" href="tel:555-0101">(907) 555-0101</a></li>
                              <li><a class="text-style-one"
                                      href="https://html.kodesolution.com/cdn-cgi/l/email-protection#bec7d1cbccd3dfd7d2feddd1d3cedfd0c790ddd1d3"><span
                                          class="__cf_email__"
                                          data-cfemail="c3baacb6b1aea2aaaf83a0acaeb3a2adbaeda0acae">[email&#160;protected]</span></a>
                              </li>
                          </ul>
                      </div>
                  </div>
